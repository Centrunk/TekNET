namespace Teknet2025Core
{
	partial class AboutBox1
	{
		...
		private void InitializeComponent()
		{
			...
			labelVersion.Text = "2025.1_Baseline";
			...
			labelCopyright.Text = "Copyright (C) 2025";
			...
			labelCompanyName.Text = "Terrestrial Agile Trunked Radio System";
			...
			textBoxDescription.Text = "Use at own risk. :3";
			// 
			// okButton
			// 
